...
\pgfplotstableset{
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot [samples=100,dashed, line width=1pt, domain=0:20, blue!50!black] {0.0180149*x^(3/2)};
		\addlegendentry{Аппроксимация $\frac32$, $P=0.018$}
		% \addplot +[mark=*, line width=1.2pt, mark size=1.1pt,  smooth,solid,red] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=u, y=i,] {../data/vax2.tsv};
