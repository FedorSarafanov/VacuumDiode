...
\pgfplotstableset{
	create on use/x/.style={
	    create col/expr={
	    1/(970.52+996.208*\thisrow{i})
	    }
	},
	create on use/y/.style={
	    create col/expr={
	    ln(\thisrow{ia}/1000)-2*ln(970.52+996.208*\thisrow{i})
	    }
	},
}
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=x, y=y,] {../data/vax41.tsv};
		\addlegendentry{$u_\text{а}=15$ В}
		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,red] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=x, y=y,] {../data/vax42.tsv};
		\addlegendentry{$u_\text{а}=60$ В}
		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,black] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=x, y=y,] {../data/vax43.tsv};
		...
		% \addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,black] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=i, y=ia,] {../data/vax43.tsv};
		  ...
		  \addplot [samples=100,dashed, line width=1pt, domain=0.0004:0.00055, blue!50!black] {1.22-53000*x};
